...
class pix2pix(object):
    def __init__(self, sess, image_size=64,
                 ...
                 gf_dim=32, df_dim=32, L1_lambda=0.001,
                 input_c_dim=1, output_c_dim=3, dataset_name='facades',
        ...
        """
        self.sess = sess
        self.is_grayscale = False #(input_c_dim == 1)
    ...
    def build_model(self):
        ...
        self.g_loss = self.L1_lambda * tf.reduce_mean(tf.abs(self.real_B - self.fake_B))
        #tf.reduce_mean(tf.nn.sigmoid_cross_entropy_with_logits(self.D_logits_, tf.ones_like(self.D_))) \
    ...
    def load_random_samples(self):
        ...
        sample = [load_lip_data_t2(sample_file) for sample_file in data]
    ...
    def sample_model(self, sample_dir, epoch, idx):
        ...
        save_lip_images_t2(samples, self.batch_size, sample_files, 'sample')
        # save_lip_images_t2(samples, [self.batch_size, 1],
    ...
    def train(self, args):
        ...
        for epoch in xrange(args.epoch):
            ...
            for idx in xrange(0, batch_idxs):
                ...
                batch = [load_lip_data_t2(batch_file) for batch_file in batch_files]
    ...
    def test(self, args):
        ...
        sample = [load_lip_data_t2(sample_file, is_test=True) for sample_file in sample_files]
        ...
        for i, sample_image in enumerate(sample_images):
            ...
            save_lip_images_t2(samples, self.batch_size, sample_files, 'test', idx)
            # save_lip_images_t2(sample_image[:,:,:,3:4], self.batch_size, idx, 'gt', sample_files)
            # save_lip_images_t2(sample_image[:,:,:,0:3], self.batch_size, idx, 'image', sample_files)
