...
parser.add_argument('--dataset_name', dest='dataset_name', default='human', help='name of the dataset')
...
parser.add_argument('--L2_lambda', dest='L2_lambda', type=float, default=0.1, help='weight on L1 term in objective')
